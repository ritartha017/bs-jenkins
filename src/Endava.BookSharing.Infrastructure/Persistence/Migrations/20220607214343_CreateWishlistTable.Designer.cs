...
namespace Endava.BookSharing.Infrastructure.Migrations
{
    ...
    [Migration("20220607214343_CreateWishlistTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Endava.BookSharing.Infrastructure.Persistence.Models.WishlistDb", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Endava.BookSharing.Infrastructure.Persistence.Models.WishlistDb", b =>
                {
                    ...
                    b.HasOne("Endava.BookSharing.Infrastructure.Persistence.Identity.Models.UserDb", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
